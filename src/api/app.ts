...
import monthlyBalance from './components/monthlyBalance/network';
import bankStatements from './components/bankStatements/network';
...
export class App {
    ...
    private routes() {
        ...
        this.app.use("/api/monthlyBalance", monthlyBalance)
        this.app.use("/api/bankStatements", bankStatements)
